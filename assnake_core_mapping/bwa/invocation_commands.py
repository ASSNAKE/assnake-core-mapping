...
@click.command('map-bwa', short_help='Map your samples on genome using Hisat2')
...
@click.option('--reference', 
                ...
                type=click.STRING )
@click.pass_obj
def map_bwa(config, df, preproc, samples_to_add, reference):
    ...
    for s in ss.samples_pd.to_dict(orient='records'):
        ...
        res_list.append( '{fs_prefix}/{df}/mapped/bwa__def/{reference}/{sample}/{preproc}/{sample}.flagstat.txt'.format(
